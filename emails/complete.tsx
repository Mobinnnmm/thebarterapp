import {
  ...
  export const NikeReceiptEmail = () => (
    <Html>
      ...
      <Body style={main}>
        <Preview>
          Your Trade Offer has been Completed!
        </Preview>
        <Container style={container}>
          <Section style={track.container}>
            <Row>
              <Column>
                <Text style={global.paragraphWithBold}>Trade Offer ID</Text>
                <Text style={track.number}>1ZV218970300071628</Text>
              </Column>
              <Column align="right">
                <Link style={global.button}>View Trade Offer</Link>
              </Column>
            </Row>
          </Section>
          <Hr style={global.hr} />
          <Section style={message}>
            {/* <Img
              ...
              style={{ margin: 'auto' }}
            /> */}
            <Heading style={global.heading}>Your Trade Offer has been Completed!</Heading>
            <Text style={global.text}>
              Your Trade Offer has been completed. Use the link above to view your Trade Offer.
            </Text>
            <Text style={{ ...global.text, marginTop: 24 }}>
              ...
              please visit your Orders page on Papermark.
            </Text>
          </Section>
          <Hr style={global.hr} />
          <Section style={global.defaultPadding}>
            <Text style={adressTitle}>Trade Offer Details</Text>
            <Text style={{ ...global.text, fontSize: 14 }}>
              Trade Offer ID: 1ZV218970300071628
            </Text>
          </Section>
          <Hr style={global.hr} />
          <Section
          ...
          <Section style={global.defaultPadding}>
            <Row style={{ display: 'inline-flex', marginBottom: 40 }}>
              ...
              <Column>
                <Text style={global.paragraphWithBold}>Trade Offer Date</Text>
                <Text style={track.number}>Sep 22, 2022</Text>
              </Column>
            </Row>
            <Row>
              <Column align="center">
                <Link style={global.button}>Trade Offer Status</Link>
              </Column>
            </Row>
          </Section>
          <Hr style={global.hr} />
          <Section style={paddingY}>
            <Row>
              <Text style={global.heading}>Trade Offer Details</Text>
            </Row>
