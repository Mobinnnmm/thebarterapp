...
//       // Use the correct Socket.IO server URL from environment variables
//       // This should point to your standalone Socket.IO server, not your Next.js app
//       const socketServerUrl = process.env.NEXT_PUBLIC_SOCKET_SERVER_URL;
      
//       console.log('Connecting to socket server at:', socketServerUrl);
      
//       // Connect directly to the Socket.IO server
